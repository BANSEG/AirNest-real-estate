...
const EstateDetails = () => {
  ...
  return (
    <div className="w-4/5 mx-auto mt-8">
      ...
      <div className="flex justify-between text-cyan-500 text-3xl font-bold">
        <h2>{house.name}</h2>
      ...
      <div className="grid grid-cols-2 gap-6 mt-8 mb-6">
        ...
        <div>
          ...
          <h4 className="text-lg font-medium">BANSEG</h4>
        </div>
      </div>
      <hr />
      ...
      <div className=" max-w-3xl p-6 border border-gray-300 rounded-lg shadow-md mt-8">
        ...
        <form>
            ...
            <div className="mb-4">
                ...
                <textarea name="message" placeholder="Hi, i'm interested in this property" className="w-full p-2 border border-gray-300 rounded-md h-24 resize-none"></textarea>
            </div>

            <button className="w-full p-3 bg-cyan-500 text-white font-semibold rounded-md hover:bg-cyan-600 transition">Submit</button>
        </form>
      </div>
